...
PROCESS = BOTH
TARGET_NAME = HelloRectangle
TARGET_PATH = HelloRectangle
INCLUDES = \
	-Ilib/Vulkan/Include \
	-Iapp/test/lib/GLFW \
	-Iapp/test/lib/glm \
	-Ibuild/vkw/inc \
	-Iapp/test/HelloRectangle
LDFLAGS = \
	-Lbuild/vkw/lib \
	-Lapp/test/lib/GLFW \
	-Llib/Vulkan/Lib
...
define POSTBUILDCMDS
	...
	glslc $(SRCDIRS)/Base.vert -o $(TARGETDIR)/vert.spv
	glslc $(SRCDIRS)/Base.frag -o $(TARGETDIR)/frag.spv
endef
